...
static const struct snd_soc_dai_ops adcx140_dai_ops = {
	...
	.digital_mute	= adcx140_mute,
};

static int adc5410_init(struct adcx140_priv *adcx140)
{
	bool internal_reg;
	...
	ret = regmap_update_bit(adcx140->regmap, ADCX140_BIAS_CFG,
				ADCX140_MIC_BIAS_VAL_MSK, bias_source);
	if (ret)
		goto out;
out:
	return ret;
				  ...
				  enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_STANDBY:
		ret = snd_soc_component_write(component, ADCX140_PWR_CFG, 0xe0);
		break;
	case SND_SOC_BIAS_OFF:
		ret = snd_soc_component_write(component, ADCX140_PWR_CFG, 0x00);
		break;
	}
